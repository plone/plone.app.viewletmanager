...
from plone.app.viewletmanager.storage import DEFAULT_SKINKEY
...
class ViewletSettingsStorageNodeAdapter(XMLAdapterBase):
    ...
    def _exportNode(self):
        ...
        for skin in [s for s in storage._order if s != DEFAULT_SKINKEY]:
        ...
        for skin in  [s for s in storage._hidden if s != DEFAULT_SKINKEY]:
